export default {
  ...
  payment: {
    ...
    lottery: {
      ...
      noPrize: '未中奖',
      adminTitle: '充值抽奖活动',
      adminHint: '充值满额后按完整倍数发放抽奖次数。奖项概率之和可小于 100%，剩余概率为未中奖。',
      enabled: '启用活动',
      threshold: '每次抽奖所需充值金额',
      prizeAmount: '奖品金额',
      probability: '中奖概率 (%)',
      addPrize: '添加奖项',
    ...
    activities: {
      ...
      consumptionHint: '按累计实际消费计算，达到档位后用户可领取一次赠送余额。',
      enabled: '启用活动',
      threshold: '达标金额',
      bonus: '赠送金额',
      addTier: '添加档位',
      rechargeBonus: '充值赠送',
      rechargeBonusShort: '赠送 ${amount}',
      giftBadge: '赠送',
      quickAmountSummary: '到账 ${total}・{draws} 次抽奖',
      totalCredited: '预计到账',
      consumptionProgress: '累计已消费 ${amount}',
      currentSpent: '当前已消费 ${amount}',
      claim: '领取 ${amount}',
      claimAction: '领取',
      claimSuccess: '领取成功，获得{amount}赠送额度',
      claimed: '已领取',
      remaining: '再消费 ${amount} 可领取 ${bonus}',
      allClaimed: '所有档位奖励已全部领取完毕',
      giftShort: '赠 {amount}',
      bonusBalance: '赠送额度（优先使用）',
      noTiers: '暂未配置活动档位',
    },
    refundReason: '退款原因',
