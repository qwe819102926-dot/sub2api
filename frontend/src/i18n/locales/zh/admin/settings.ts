export default {
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          title: '模型广场',
          description: '以分组为单位向访客展示可用模型与价格的公开页面，模型和倍率从分组/渠道配置自动识别。默认关闭。',
          enabled: '启用模型广场',
          enabledHint: '开启后顶栏显示入口，页面可通过 /model-plaza 独立访问；分组模型列表、分组倍率和分组定价会自动同步。',
      ...
      site: {
        ...
        imageApiBaseUrl: '生图 API 端点地址',
        imageApiBaseUrlPlaceholder: '留空则使用 API 端点地址',
        imageApiBaseUrlHint: '用于在 API 密钥页面显示生图接口地址，留空则不单独显示',
        ...
        contactInfo: '客服联系方式',
        contactInfoPlaceholder: '例如：QQ: 819102926',
        contactInfoHint: '填写客服联系方式，将展示在兑换页面、个人资料等位置。顶部客服入口固定展示客服 QQ 二维码。',
        docUrl: '文档链接',
      ...
      payment: {
        ...
        field_clientNo: '商户号 ClientNo',
        field_merchantKey: '商户 KEY',
        ...
        jianpayWebhookHint: '请在 JianPay 商户后台将以下地址配置为支付通知地址；商户 KEY 仅保存在服务端。',
