export default {
    ...
    users: {
      ...
      withdraw: '退款',
      lotteryChances: '抽奖次数',
      lotteryChancesTitle: '设置抽奖次数',
      currentLotteryChances: '当前剩余次数',
      lotteryChancesLabel: '剩余抽奖次数',
      lotteryChancesHint: '设置后将精确覆盖用户当前剩余次数，已完成的抽奖记录不受影响。',
      lotteryChancesUpdated: '抽奖次数更新成功',
      lotteryChancesInvalid: '请输入 0 到 1000000 之间的整数',
      failedToLoadLotteryChances: '加载抽奖次数失败',
      failedToUpdateLotteryChances: '更新抽奖次数失败',
      depositAmount: '充值金额',
      withdrawAmount: '退款金额',
      withdrawAll: '全部',
      ...
      depositSuccess: '充值成功',
      adjustBonusBalance: '调整赠送余额',
      adjustBonusBalanceTitle: '调整赠送余额',
      adjustBonusBalanceAction: '调整',
      currentBonusBalance: '当前赠送余额',
      bonusBalanceAmount: '调整金额',
      bonusBalanceAdd: '增加',
      bonusBalanceSubtract: '扣减',
      newBonusBalance: '操作后赠送余额',
      insufficientBonusBalance: '赠送余额不足',
      adjustBonusBalanceSuccess: '赠送余额调整成功',
      bonusBalanceUnavailable: '赠送余额加载失败',
      failedToAdjustBonusBalance: '调整赠送余额失败',
      bonusBalanceAddedAdmin: '赠送余额增加（管理员）',
      bonusBalanceDeductedAdmin: '赠送余额扣减（管理员）',
