export default {
  ...
  payment: {
    ...
    lottery: {
      ...
      adminHint: 'Each full recharge threshold earns one chance. Prize probabilities may total less than 100%; the remainder is no prize.',
      enabled: 'Enable campaign',
      threshold: 'Recharge per draw',
    ...
    activities: {
      ...
      consumptionHint: 'Rewards are available once for each cumulative actual-spend tier.',
      enabled: 'Enable campaign',
      threshold: 'Spend threshold',
      bonus: 'Bonus amount',
      addTier: 'Add tier',
      rechargeBonus: 'Top-up bonus',
      rechargeBonusShort: '+${amount} bonus',
      giftBadge: 'Gift',
      quickAmountSummary: 'Get ${total} · {draws} draw(s)',
      totalCredited: 'Total credited',
      consumptionProgress: 'Total spent: ${amount}',
      currentSpent: 'Current spend: ${amount}',
      claim: 'Claim ${amount}',
      claimAction: 'Claim',
      claimSuccess: 'Claimed {amount} bonus balance',
      claimed: 'Claimed',
      remaining: 'Spend ${amount} more to claim ${bonus}',
      allClaimed: 'All tier rewards have been claimed',
      giftShort: 'Gift {amount}',
      bonusBalance: 'Bonus balance (used first)',
      noTiers: 'No campaign tiers configured',
    },
