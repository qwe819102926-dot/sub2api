export default {
    ...
    users: {
      ...
      deposit: 'Deposit',
      withdraw: 'Withdraw',
      lotteryChances: 'Lottery Chances',
      lotteryChancesTitle: 'Set Lottery Chances',
      currentLotteryChances: 'Current Remaining Chances',
      lotteryChancesLabel: 'Remaining Lottery Chances',
      lotteryChancesHint: 'This precisely replaces the user\'s remaining chances; completed draws are not affected.',
      lotteryChancesUpdated: 'Lottery chances updated successfully',
      lotteryChancesInvalid: 'Enter an integer between 0 and 1000000',
      failedToLoadLotteryChances: 'Failed to load lottery chances',
      failedToUpdateLotteryChances: 'Failed to update lottery chances',
      ...
      adjustBonusBalance: 'Adjust Bonus Balance',
      adjustBonusBalanceTitle: 'Adjust Bonus Balance',
      adjustBonusBalanceAction: 'Adjust',
      currentBonusBalance: 'Current Bonus Balance',
      bonusBalanceAmount: 'Adjustment Amount',
      bonusBalanceAdd: 'Add',
      bonusBalanceSubtract: 'Subtract',
      newBonusBalance: 'Bonus Balance After Adjustment',
      insufficientBonusBalance: 'Insufficient bonus balance',
      adjustBonusBalanceSuccess: 'Bonus balance adjusted',
      bonusBalanceUnavailable: 'Failed to load bonus balance',
      failedToAdjustBonusBalance: 'Failed to adjust bonus balance',
      bonusBalanceAddedAdmin: 'Bonus Balance Added (Admin)',
      bonusBalanceDeductedAdmin: 'Bonus Balance Deducted (Admin)',
      ...
      typeAdminBonus: 'Bonus Balance (Admin)',
