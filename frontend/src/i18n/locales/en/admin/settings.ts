export default {
    settings: {
      ...
      site: {
        ...
        contactInfoPlaceholder: 'e.g., QQ: 819102926',
        contactInfoHint: 'Customer support contact info, displayed on redeem page and profile. The top customer-service entry uses the fixed support QQ QR code.',
      ...
      payment: {
        ...
        field_clientNo: 'Merchant ClientNo',
        ...
        jianpayWebhookHint: 'Configure the following URL as the JianPay payment notification URL. The merchant key is stored on the server only.',
