export default {
  dashboard: {
    ...
    bonusBalanceHint: 'Used first for API usage',
    apiKeys: 'API Keys',
  ...
  usage: {
    ...
    rangeProfit: 'Range profit',
    profitFormula: 'Profit = wallet spend − cost',
    profitHint: 'Wallet spend is principal balance actually deducted, excluding bonus. Bonus spend is the bonus balance actually deducted. Subscriptions are not counted as principal or bonus. Cost is account cost in the selected range.',
