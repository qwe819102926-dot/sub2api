      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.todayCostHint')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-purple-600 dark:text-purple-400" :title="t('dashboard.todayCostHint')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
