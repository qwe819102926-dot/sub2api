            ...
            <div class="space-y-6 p-6">
              ...
              <div>
                <label
                  class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300"
                >
                  {{ t("admin.settings.site.imageApiBaseUrl") }}
                </label>
                <input
                  v-model="form.image_api_base_url"
                  type="text"
                  class="input font-mono text-sm"
                  :placeholder="t('admin.settings.site.imageApiBaseUrlPlaceholder')"
                />
                <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t("admin.settings.site.imageApiBaseUrlHint") }}
                </p>
              </div>
...
const allPaymentTypes = computed(() => [
  ...
  { value: "jianpay", label: t("payment.methods.jianpay") },
...
const providerKeyOptions = computed(() => [
  ...
  { value: "jianpay", label: t("admin.settings.payment.providerJianpay") },
...
function getProviderVisibleMethods(
  ...
  } else if (provider.provider_key === "easypay" || provider.provider_key === "jianpay") {
