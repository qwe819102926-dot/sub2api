<template>
  <AppLayout>
    ...
    <RechargeLotteryCard :show="showLottery" @available="showLottery = true" @close="showLottery = false" @open="showLottery = true" @drawn="loadStats" />
  </AppLayout>
</template>
...
import DashboardContactQr from '@/components/user/dashboard/DashboardContactQr.vue'
